...
-----END RSA PUBLIC KEY-----",
    ...
    public static Dictionary<string, string> SekiroKeys = new() {
        ["Data1"] =
            @"-----BEGIN RSA PUBLIC KEY-----
...
-----END RSA PUBLIC KEY-----",
    ...
    public static Dictionary<string, string> SekiroBonusKeys = new() {
        ["Data"] =
            @"-----BEGIN RSA PUBLIC KEY-----
...
-----END RSA PUBLIC KEY-----",
    ...
    public static Dictionary<string, string> EldenRingKeys = new() {
        ["Data0"] =
            @"-----BEGIN RSA PUBLIC KEY-----
...
-----END RSA PUBLIC KEY-----",
    ...
    public static Dictionary<string, string> ArmoredCore6Keys = new() {
        ["Data0"] =
            @"-----BEGIN RSA PUBLIC KEY-----
